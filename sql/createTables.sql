...
INSERT INTO email_templates (name, description, subject, header_fi, footer_fi) VALUES
    ('Vanhenemisviesti', 'Viesti tallenteiden vanhenemisesta', 'sinulla on vanhenevia tallenteita / you have expiring videos / du har videon som föråldras', 'Hei!Saat tämän viestin, koska olet Helsingin yliopiston Unitube-palvelussa yhden tai useamman vanhenevan videotallenteen hallinnoija.
